...
const Home: NextPage = () => {
      ...
      return (
      	     <div className="flex justify-center items-center bg-gray-200 w-screen relateive">
	     	  <Head>
		  ...
		  <main className="items-cener h-screen w-1/3 justify-start flex bg-[#0090CD] flex-col">
			...
			<div className="flex-row flex items-center mb-11 mt-7">
		  	...
		  	<div className="z-10 mt-16 mb-16 text-3xl items-center flex flex-col text-[#009DC]">
			     <div>SHAR YOUR</div>
			     <div>WONDERFUL DAILY LIFE</div>
			     <div>ON ASTAR</div>
			</div>
			<button
				className="z-10 text-3xl text-white items-center flex justify-center h-20 w-722 bg-[#003AD0] hover:bg-blue-700 py-2 px-4 rounded-full"
				onClick={() => {
					    router.push("home");
				}}
			>
			...
			<Image
			  ...
			  height={40}
		     	/>
			<Image
			  className="rotate-[40deg] h-10 w-10 top-8 left-1/3 absolute"
			  src="/cross_star_6_logo-removebg.png"
			  alt="astar_logo"
			  width={35}
			  height={30}
			...
			<Image
			  ...
			  height={200}
		     	/>
			<Image
			  className="rotate-[25deg] h-24 w-24 fill-black bottom-48 left-1/3 absolute"
			  src="/cross_star_2_logo-removebg.png"
			  alt="astar_logo"
			  width={100}
			  height={200}
