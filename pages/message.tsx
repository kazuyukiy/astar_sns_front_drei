...
import MessageRoom from "../components/message_room";
import TopBar from "../components/topBar";
import { connectToContract } from "../hooks/connect";
import { balanceOf } from "../hooks/FT";
import { getLastMessage, getMessageList } from "../hooks/posFunction";
import {
       checkCreatedInfo,
       createProfile,
...
export default function message() {
	 ...
	 setIsCreatedFnRun(true);
       ...
       // create message menbeer list UI
