       ...
       return is_me ? (
			...
			<div className={`mt-3`}>
			     <div className="flex-row flex items-center">
				  ...
				  {is_me ? (
				  	 <div className="border-t-transparent border-b-[10px] border-b-transparent border-1-[20px] border-1-blue-500"></div>
				  ) : null}
			     </div>
			</div>
       	 ...
       	 <div className="w-full justify-start items-end flex mt-3 mb-1">
	      	   ...
	      	   <Image className="rounded-full h-10 w-10 mx-2 items-center"
		   	  src={props.img_url}
			  alt="profile_logo"
			  width={30}
			  height={30}
		   ...
		   />
		   	...
		   	<div className="{`mt-3`}">
			     <div className="flex-row flex items-center">
				  ...
				  <div className="bd-blue-500 py-1 px-3 rounded max-w-[230px]">
				       <div>{props.message}</div>
       	      	   	     	  </div>
       	      	   	     </div>
       	      	   	</div>
